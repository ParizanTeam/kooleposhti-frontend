          ...
          >
            ...
            <Formik
              ...
              validate={values => {
                let error = {};
                if (!values.firstName) {
                  error.firstName = 'لطفا نام خود را وارد کنید';
                  ...
                  error.rePassword = 'لطفا رمز عبور خود را دوباره وارد کنید';
                } else if (values.rePassword !== values.password) {
                  error.rePassword = 'تکرار رمز عبور تطابق ندارد';
                }
            ...
            >
              {({ handleSubmit, handleChange, values, errors }) => (
                <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sx={{ mt: 1 }}>
                      <FormControl component="fieldset">
                        <FormLabel component="legend" sx={{ fontFamily: 'iranyekan' }}>
                          حساب کاربری
                        </FormLabel>
                        <RadioGroup
                          row
                  ...
                  <Button type="submit" fullWidth variant="contained" sx={{ fontFamily: 'iranyekan', mt: 3 }}>
                    ثبت نام
                  </Button>
                    ...
                    <Grid item>
                      <Container sx={{ mt: 2, mr: 0 }}>
                        ...
                        >
                          ...
                          <Button sx={{ color: 'rgb(76, 175, 80)', fontSize: '15px', fontFamily: 'iranyekan' }}>
                            ورود
                          </Button>
                        </Link>
                      </Container>
